...
**DYNC1H1** (0.826, 6 layers) encodes cytoplasmic dynein heavy chain 1, the motor subunit of the cytoplasmic dynein-1 complex, which drives minus-end-directed microtubule transport and contributes to centrosome positioning. Mutations cause neurodevelopmental disorders with reported sensory involvement [25]. Its ranking is driven by centrosome/ciliary localization (score 1.0), extensive cilia-related literature (0.998), and high gnomAD constraint (0.966); the animal-model layer contributes only modestly (0.169), as many *Dync1h1* phenotypes are annotated under neurodevelopmental rather than sensory terms.

**PAFAH1B1** (0.798, 6 layers) encodes the LIS1 protein, a regulatory factor essential for cytoplasmic dynein-1 activity. LIS1 supports dynein-dependent centrosome positioning and microtubule-based transport [24], and mutations cause lissencephaly with documented retinal involvement. Its ranking derives from centrosome localization (1.0), literature evidence (0.988), and strong gnomAD constraint (0.969); as with DYNC1H1, its sensory animal-model score is low (0.048) because the vestibular and visual defects in *Lis1* mutant mice are annotated under neurodevelopmental rather than sensory phenotype terms.
