# UsherPipe: a genome-wide multi-evidence pipeline for prioritizing under-studied Usher syndrome and ciliopathy genes
...
Usher syndrome (USH) is the most prevalent cause of hereditary combined deafness and blindness, affecting approximately 4–17 per 100,000 individuals worldwide [1]. Patients present with sensorineural hearing loss, vestibular dysfunction, and progressive retinitis pigmentosa. Three clinical subtypes are recognized (USH1, USH2, USH3), caused by pathogenic variants in ten genes: *MYO7A*, *USH1C*, *CDH23*, *PCDH15*, *USH1G*, *CIB2* (USH type 1); *USH2A*, *ADGRV1*, *WHRN* (type 2); and *CLRN1* (type 3) [2]. These genes encode proteins that form multi-protein complexes in the stereocilia of inner ear hair cells and the connecting cilium of retinal photoreceptors [3]. Despite this genetic framework, even comprehensive sequencing of the known genes identifies causal biallelic variants in approximately 93% of clinically diagnosed USH patients [4].

Even after comprehensive genomic screening—including targeted gene panels, whole-exome sequencing (WES), whole-genome sequencing (WGS), and copy number variant (CNV) analysis—the molecular cause remains unresolved in approximately 10% of individuals with clinically diagnosed Usher syndrome. Several possibilities account for these unresolved molecular diagnoses, including novel disease genes, noncoding or deep intronic variants, complex structural variants, regulatory alterations, digenic or oligogenic inheritance, and the influence of modifier genes. Although sequencing technologies continue to advance, identifying sequence variants is no longer the principal challenge for many unresolved cases. Instead, the major bottleneck has shifted to distinguishing truly disease-relevant genes from hundreds of biologically plausible but poorly characterized candidates. Throughout, we use *candidate* in the sense established by the ClinGen gene–disease validity framework [5]: a gene in a proposed but not yet established gene–disease relationship, as distinct from the ten known Usher genes. This challenge is particularly pronounced because the remaining undiscovered disease genes are expected to be under-studied, with sparse functional annotation, limited experimental evidence, and incomplete biological characterization.

### Usher syndrome as a specialized sensory ciliopathy

Ciliopathies comprise a genetically and phenotypically heterogeneous class of inherited disorders arising from structural or functional aberrations in primary cilia, motile cilia, or their anchor proteins [6]. Given that cilia serve as indispensable hubs for developmental signaling cascades, sensory perception, and fluid homeostasis, ciliary dysfunction characteristically manifests as pleiotropic, multisystemic pathologies. These conditions frequently impair the retina, kidneys, central nervous system, skeleton, liver, and reproductive tracts, spanning a clinical spectrum from isolated sensory deficits to complex, syndromic phenotypes with profound clinical overlap.
...
**VANGL2** (OMIM *600533; composite score: 0.802, 5 layers) is a core component of the planar cell polarity (PCP) signaling pathway and plays essential roles in neural tube closure, directed cell migration, planar orientation of inner ear hair cells, left–right axis establishment [40], and cardiac development [41]. Its top ranking is driven by strong cross-species animal model evidence (score 0.640; *Vangl2* mutant mice show inner ear and neural tube defects), extensive cilia/polarity literature (0.940), and high gnomAD constraint (0.802). VANGL2 lacks systematic subcellular localization data (NULL); the NULL-aware design still surfaces it as a strong candidate, whereas zero imputation would penalize it. In humans, current evidence suggests that VANGL2 functions primarily as a susceptibility gene for neural tube defects, with incomplete penetrance and likely oligogenic or multifactorial inheritance, rather than as a highly penetrant monogenic disease gene [42].

**DYNC1H1** (OMIM *600112; 0.826, 6 layers) encodes cytoplasmic dynein heavy chain 1, the motor subunit of the cytoplasmic dynein-1 complex, which drives minus-end-directed microtubule transport and contributes to centrosome positioning. In humans, high-impact variants cause a spectrum of autosomal dominant neurodevelopmental and neuromuscular disorders [43]. A minority of reports have also noted cataracts, visual impairment, or other ocular abnormalities [44]. The gene's high ranking in our system is driven by its prominent centrosome/ciliary localization (score 1.0), extensive cilia-related literature (0.998), and strong gnomAD constraint (0.966). Conversely, the animal-model layer contributes only modestly (0.170); according to the Mouse Genome Informatics (MGI) database [36], various missense or null alleles of *Dync1h1* exhibit neurodevelopmental, behavioral, neuromuscular, and mortality phenotypes rather than sensory abnormalities.

**PAFAH1B1** (OMIM *601545; 0.798, 6 layers) encodes the LIS1 protein, a critical regulatory factor essential for cytoplasmic dynein-1 activity. LIS1 mediates dynein-dependent centrosome positioning and microtubule-based transport [6], and its loss-of-function alleles cause autosomal dominant cortical malformations, including classical lissencephaly and subcortical laminar heterotopia (both OMIM #607432) [45, 46]. Notably, PAFAH1B1 was among the earliest genes recognized to cause classical lissencephaly [47]. In our system, its high ranking derives from prominent centrosome localization (score 1.0), extensive literature evidence (0.988), and strong gnomAD constraint (0.969). Conversely, as with DYNC1H1, its animal-model score is low (0.048); according to MGI [36], *Pafah1b1* mutant phenotypes are concentrated in neurodevelopmental, reproductive, and cellular categories, closely reflecting its core role in microtubule regulation and dynein function rather than sensory phenotypes.

**ATP2B2** (ATPase plasma membrane Ca²⁺ transporting 2; 0.786, 5 layers) encodes plasma membrane calcium ATPase 2 (PMCA2), a P-type Ca²⁺ ATPase critical for maintaining intracellular calcium homeostasis. The *deafwaddler* mouse, which carries a spontaneous disease-causing *Atp2b2* allele, exhibits profound hearing loss and vestibular dysfunction [48]. Homozygous mutants show growth retardation, balance impairment, and deafness, whereas heterozygous mice develop age-dependent hearing loss. These auditory and vestibular abnormalities partially recapitulate features of Usher syndrome type 1. Nevertheless, ATP2B2 has not been systematically evaluated as a candidate gene for human Usher syndrome.

The list also recovers established ciliopathy genes as a sanity check: **ARL3** (0.755, 6 layers, 99.8th percentile), a small GTPase that traffics lipid-modified proteins to the cilium and whose knockout mice develop retinal degeneration [49], and **AHI1** (0.785, 6 layers), the known Joubert-syndrome gene. That both rank among the top candidates indicates the corrected six-layer scoring captures bona fide ciliary biology.
...
Promising extensions include protein-protein interaction network analysis (leveraging the Usher protein interactome [52]), validation of the fetal GSE135913 signal against adult cochlear datasets with author-curated inner- and outer-hair-cell annotations, integration of cochlear hair-cell proteomics, and a web interface for interactive exploration of candidate gene evidence profiles. Experimental validation of top candidates (particularly VANGL2, ATP2B2, and DYNC1H1) through immunolocalization in retinal and cochlear tissue would provide the strongest support for their candidacy.
...
[5] Strande NT, et al. Evaluating the clinical validity of gene-disease associations: an evidence-based framework developed by the Clinical Genome Resource. Am J Hum Genet. 2017;100(6):895-906.

[6] Reiter JF, Leroux MR. Genes and molecular pathways underpinning ciliopathies. Nat Rev Mol Cell Biol. 2017;18(9):533-547.

[7] Cosgrove D, Zallocchi M. Usher protein functions in hair cells and photoreceptors. Int J Biochem Cell Biol. 2014;46:80-89.

[8] Maerker T, et al. A novel Usher protein network at the periciliary reloading point between molecular transport machineries in vertebrate photoreceptor cells. Hum Mol Genet. 2008;17(1):71-86.

[9] Sahly I, et al. Localization of Usher 1 proteins to the photoreceptor calyceal processes, which are absent from mice. J Cell Biol. 2012;199(2):381-399.

[10] El-Amraoui A, Petit C. Usher I syndrome: unravelling the mechanisms that underlie the cohesion of the growing hair bundle in inner ear sensory cells. J Cell Sci. 2005;118(Pt 20):4593-4603.

[11] Lefèvre G, et al. A core cochlear phenotype in USH1 mouse mutants implicates fibrous links of the hair bundle in its cohesion, orientation and differential growth. Development. 2008;135(8):1427-1437.

[12] Schwander M, Kachar B, Müller U. The cell biology of hearing. J Cell Biol. 2010;190(1):9-20.

[13] Bahloul A, et al. Cadherin-23, myosin VIIa and harmonin, encoded by Usher syndrome type I genes, form a ternary complex and interact with membrane phospholipids. Hum Mol Genet. 2010;19(18):3557-3565.

[14] Wang H, et al. Temporal and spatial assembly of inner ear hair cell ankle link condensate through phase separation. Nat Commun. 2023;14(1):1657.

[15] Yang J, et al. Ablation of whirlin long isoform disrupts the USH2 protein complex and causes vision and hearing loss. PLoS Genet. 2010;6(5):e1000955.

[16] Geng R, et al. The mechanosensory structure of the hair cell requires clarin-1, a protein encoded by Usher syndrome III causative gene. J Neurosci. 2012;32(28):9485-9498.

[17] Nonarath HJT, et al. The USH3A causative gene clarin1 functions in Müller glia to maintain retinal photoreceptors. PLoS Genet. 2025;21(3):e1011205.

[18] Kremer H, et al. Usher syndrome: molecular links of pathogenesis, proteins and pathways. Hum Mol Genet. 2006;15(Spec No 2):R262-R270.

[19] Aerts S, Lambrechts D, Maity S, et al. Gene prioritization through genomic data fusion. Nat Biotechnol. 2006;24(5):537-544.

[20] Chen J, Bardes EE, Aronow BJ, Jegga AG. ToppGene Suite for gene list enrichment analysis and candidate gene prioritization. Nucleic Acids Res. 2009;37(Web Server issue):W305-W311.

[21] Smedley D, et al. Next-generation diagnostics and disease-gene discovery with the Exomiser. Nat Protoc. 2015;10(12):2004-2015.

[22] Birgmeier J, et al. AMELIE speeds Mendelian diagnosis by matching patient phenotype and genotype to primary literature. Sci Transl Med. 2020;12(544):eaau9113.

[23] van Dam TJP, et al. CiliaCarta: An integrated and validated compendium of ciliary genes. PLoS One. 2019;14(5):e0216705.

[24] Pir MS, et al. CilioGenics: an integrated method and database for predicting novel ciliary genes. Nucleic Acids Res. 2024;52(14):8127-8145.

[25] Vitsios D, Petrovski S. Mantis-ml: disease-agnostic gene prioritization from high-throughput genomic screens by stochastic semi-supervised learning. Am J Hum Genet. 2020;106(5):659-678.

[26] Xin J, et al. High-performance web services for querying gene and variant annotation. Genome Biol. 2016;17(1):91.

[27] Chen S, Francioli LC, Goodrich JK, et al. A genomic mutational constraint map using variation in 76,156 human genomes. Nature. 2024;625(7993):92-100.

[28] Uhlén M, et al. Proteomics. Tissue-based map of the human proteome. Science. 2015;347(6220):1260419.

[29] GTEx Consortium. The GTEx Consortium atlas of genetic regulatory effects across human tissues. Science. 2020;369(6509):1318-1330.

[30] CZI Single-Cell Biology, et al. CZ CELLxGENE Discover: A single-cell data platform for scalable exploration, analysis and modeling of aggregated data. Nucleic Acids Res. 2025;53(D1):D886-D900.

[31] Gene Ontology Consortium. The Gene Ontology resource: enriching a GOld mine. Nucleic Acids Res. 2021;49(D1):D325-D334.

[32] UniProt Consortium. UniProt: the Universal Protein Knowledgebase in 2023. Nucleic Acids Res. 2023;51(D1):D523-D531.

[33] Kanehisa M, Goto S. KEGG: Kyoto Encyclopedia of Genes and Genomes. Nucleic Acids Res. 2000;28(1):27-30.

[34] Gillespie M, et al. The reactome pathway knowledgebase 2022. Nucleic Acids Res. 2022;50(D1):D687-D692.

[35] Yates B, et al. HCOP: the HGNC comparison of orthology predictions search tool. Brief Bioinform. 2021;22(6):bbab137.

[36] Blake JA, et al. Mouse Genome Database (MGD): knowledgebase for mouse-human comparative biology. Nucleic Acids Res. 2021;49(D1):D981-D987.

[37] Bradford Y, et al. Zebrafish information network, the knowledgebase for Danio rerio research. Genetics. 2022;220(4):iyac016.

[38] Groza T, et al. The International Mouse Phenotyping Consortium: comprehensive knockout phenotyping underpinning the study of human disease. Nucleic Acids Res. 2023;51(D1):D1038-D1045.

[39] Sayers EW, et al. Database resources of the National Center for Biotechnology Information in 2023. Nucleic Acids Res. 2023;51(D1):D29-D38.

[40] Bailly E, Walton A, Borg JP. The planar cell polarity Vangl2 protein: from genetics to cellular and molecular functions. Semin Cell Dev Biol. 2018;81:62-70.

[41] Henderson DJ, Phillips HM, Chaudhry B. Vang-like 2 and noncanonical Wnt signaling in outflow tract development. Trends Cardiovasc Med. 2006;16(2):38-45.

[42] Kibar Z, et al. Contribution of VANGL2 mutations to isolated neural tube defects. Clin Genet. 2011;80(1):76-82.

[43] Harms MB, et al. Mutations in the tail domain of DYNC1H1 cause dominant spinal muscular atrophy. Neurology. 2012;78(22):1714-1720.

[44] Hertecant J, et al. A novel de novo mutation in DYNC1H1 gene underlying malformation of cortical development and cataract. Meta Gene. 2016;9:124-127.

[45] Lo Nigro C, et al. Point mutations and an intragenic deletion in LIS1, the lissencephaly causative gene in isolated lissencephaly sequence and Miller-Dieker syndrome. Hum Mol Genet. 1997;6(2):157-164.

[46] Pilz DT, et al. Subcortical band heterotopia in rare affected males can be caused by missense mutations in DCX (XLIS) or LIS1. Hum Mol Genet. 1999;8(9):1757-1760.

[47] Reiner O, et al. Isolation of a Miller-Dieker lissencephaly gene containing G protein beta-subunit-like repeats. Nature. 1993;364(6439):717-721.

[48] Street VA, et al. Mutations in a plasma membrane Ca2+-ATPase gene cause deafness in deafwaddler mice. Nat Genet. 1998;19(4):390-394.

[49] Hanke-Gogokhia C, et al. Arf-like Protein 3 (ARL3) Regulates Protein Trafficking and Ciliogenesis in Mouse Photoreceptors. J Biol Chem. 2016;291(13):7142-7155.

[50] Vasquez SSV, van Dam J, Wheway G. An updated SYSCILIA gold standard (SCGSv2) of known ciliary genes, revealing the vast progress that has been made in the cilia research field. Mol Biol Cell. 2021;32(21):br13.

[51] Stoeger T, et al. Large-scale investigation of the reasons why potentially important genes are ignored. PLoS Biol. 2018;16(9):e2006643.

[52] Linnert J, et al. Usher syndrome proteins ADGRV1 (USH2C) and CIB2 (USH1J) interact and share a common interactome containing TRiC/CCT-BBS chaperonins. Front Cell Dev Biol. 2023;11:1199069.
