...
**DYNC1H1** (composite score: 0.749, 6 layers), encoding cytoplasmic dynein heavy chain 1, directly participates in intraflagellar transport — the fundamental trafficking mechanism within cilia. Mutations cause neurodevelopmental disorders with reported sensory involvement [25]. Its top ranking reflects convergent support from high gnomAD constraint, strong animal model phenotypes, and literature evidence.
...
- **Programming language:** Python 3.12+ (tested with 3.12.12 and 3.13.11)
